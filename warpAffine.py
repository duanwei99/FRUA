...
class PyFAT:
    ...
    def generate(self, im_a, im_v, n):
        ...
        diff = np.load("/data/hdd/duanwei/FRUA/some-resources-master/output/03-02-21-24diff.npy")
        diff = att_img + diff
...
def main(args):
    ...
    origin_att_img = cv2.imread("/data/hdd/duanwei/FRUA/some-resources-master/images/003/1.png")
    adv_img = tool.generate(origin_att_img, origin_att_img, 0)
    cv2.imwrite("clip4.png", adv_img)
