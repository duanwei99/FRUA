...
class PyFAT:
    ...
    def generate(self, time):
        ...
        for path in tqdm(root.iterdir()):
            ...
            if len(att_img)==100:
                break
        # np.save("feature_cfp_fp.npy",feat)
        # att_img = np.load('feature_agedb.npy')[0:100]
        vic_imgs = np.load('/data/hdd/duanwei/FRUA/sphereface_pytorch-master/feature2_sphere.npy')
        ...
        np.save("spec_feat_sphereface_cfp.npy",spc_feat)
        ...
        summary = "SphereFace Model detla=10/127.5 cfp-fp resize"
