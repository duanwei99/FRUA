...
class PyFAT:
    ...
    def generate(self, time):
        ...
        # # wolf_img = torch.zeros_like(org_img[rand])
        ...
        for i in enumerate(a):
            ...
            wolf_feats = []
            for k,image in enumerate(org_img[1:25]):
        ...
        np.save("spec_feat3.npy",spc_feat)
        ...
        summary = "mobileFace Model detla=10/127.5 iter2000 clip init rand = 2"
