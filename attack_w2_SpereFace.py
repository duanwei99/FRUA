...
class PyFAT:
    ...
    def generate(self, time, w2):
        ...
        att_img = np.load('feature1_sphere.npy')
        vic_imgs = np.load('feature2_sphere.npy')
        ...
        np.save('log/w2/w2_24Sphere_'+str(w2)+'diff.npy',diff)
        # summary = "mobileFace Model w1:w2 = 1:100 detla=10/127.5 iter2000 clip  cosine_decay_with_warmup"
        with open("log/w2/w2_24sphere_log.txt",'a') as fp2:
